...
notify-send "NEED PASSWORD" "in initial_setup.bash"
sudo eopkg install vscode mpv tilix vlc kdenlive gimp simplescreenrecorder
guvcview gitg taskwarrior calcurse liferea simple-scan hplip hplip-drivers
postgresql sqlite3 mongodb pandoc firefox opera-stable cdrtools iftop zeal
gnuplot nasc strace audacity dia macchanger texlive texlive-fonts-extra
newsbeuter recoll okular gource gsmartcontrol --yes
